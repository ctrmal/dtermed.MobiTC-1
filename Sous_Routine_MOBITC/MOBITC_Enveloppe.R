...
# nom_projet = "TPM"
# NomTDCinit = rbind(
#   "TdC_1972_CD83_TPM_MobiTC_test.shp",
#   "TdC_1998_CD83_TPM_MobiTC_test.shp",
#   "TdC_2003_CD83_TPM_MobiTC_test.shp",
#   "TdC_2008_CD83_TPM_MobiTC_test.shp",
#   "TdC_2014_CD83_TPM_MobiTC_test.shp",
#   "N_traits_cote_naturels_recents_fr_epsg2154_L_TPM_test.shp",
#   "N_traits_cote_naturels_anciens_fr_epsg2154_L_TPM_test.shp"
# )
...
MOBITC_Enveloppe <-
  ...
  )
  {
    ...
    SPDFb <- gBuffer(SPDF, byid = TRUE, width = 0.1)
    ...
    SPDFF = SpatialPolygonsDataFrame(SPDFUD, data = data.frame(sapply(slot(SPDFUD, 'polygons'), function(x)
      slot(x, 'ID'))))
