...
#############""MENU ENVELOPPE###############"
    tabPanel(title = "Enveloppe",
		...
		mainPanel(
		  tabsetPanel(
		    tabPanel("Résultats",icon=icon("map"),textOutput("textenv"),plotOutput("mapenv")),
...
#############MENU LIGNE DE BASE############"
    navbarMenu(title = "Ligne de base",
			tabPanel(title="Création du squelette",
				...
				mainPanel(
				  tabsetPanel(
				    tabPanel("Résultats",icon=icon("map"),textOutput("textsque"),plotOutput("mapsque")),
			...
			tabPanel(title="Raccordement du squelette",
				...
				mainPanel(
				  tabsetPanel(
				    tabPanel("Résultats",icon=icon("map"),textOutput("textsquerac"),plotOutput("mapsquerac")),
   ...
   mainPanel(
     tabsetPanel(
       ...
       tabPanel("Aide", icon=icon("info-circle"),aide$aide_graph)
		...
		), #fin tabPanel(title="Raport évolution",
